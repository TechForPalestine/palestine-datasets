...
file_path = f"{working_dir}/raw/20240921.csv"
...
source_mapping = {
    ...
    "سجلات وزارة الصحة": "h", # health ministry
    "معتمد بقرار لجنة قضائية": "j", # judicial committee
    "بيت - لجنة": "j", # judicial committee
}
...
file_out = f"{working_dir}/output/20240921_input_reconcile.csv"
