...
export type {
  ...
  InfrastructureDamagedCivicBuildings,
  InfrastructureDamagedEducationalBuildings,
  InfrastructureDamagedPlacesOfWorship,
  InfrastructureDamagedResidential,
} from "./infrastructure-damaged.types";
