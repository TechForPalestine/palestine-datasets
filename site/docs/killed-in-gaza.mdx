...
Last updated on September 21, 2024 (see source info below). We're working on updating our list to include the Ministry release from March 2025 of over fifty thousand names. In the interim, you can refer to the list provided by Iraq Body Count in [PDF format](https://www.iraqbodycount.org/pal/moh_2025-03-23.pdf) or [Excel format](https://iraqbodycount.org/pal/ibc_moh_2025-03-23.xlsx). You can also refer to [the IBC post on X/Twitter](https://x.com/iraqbodycount/status/1904963717202129134) for more background on their efforts.
