---
description: List of known victims with their arabic name, english name, birth date, gender, and ID number. Issued by health officials in Gaza. Available in JSON and CSV formats. Useful applications include tributes, demographics, search, family analysis.
---
