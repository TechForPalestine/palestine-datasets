...
Latest data available is as of June 15, 2025 (see source info below).
...
In their initial initial January update, the Ministry indicated the following about the list:
