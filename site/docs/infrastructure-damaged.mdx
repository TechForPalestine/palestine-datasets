...
<DocWarningBubble>
  Gaza is nearly entirely destroyed. By some estimates over 90% of buildings and
  infrastructure have been targeted in some way. Updates on these statistics
  have slowed from the earlier weekly frequency to every month or longer.
</DocWarningBubble>
