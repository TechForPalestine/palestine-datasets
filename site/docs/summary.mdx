...
Except for `killedInGazaListCount`, all of the fields in the summary dataset derive from the latest report values in our [Daily Casualties dataset](/docs/casualties-daily).
