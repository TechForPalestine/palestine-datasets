...
- for Daily Casualties in [Gaza](/docs/casualties-daily), the [West Bank](/docs/casualties-daily-west-bank) and [Lebanon](/docs/casualties-daily-lebanon) it provides cumulative values from the latest reported day
...
The object has the following root-level fields:
...
Has the latest cumulative values from the last report in our [Lebanon Daily Casualties dataset](/docs/casualties-daily-lebanon):

| field name    | value                                                                  |
| ------------- | ----------------------------------------------------------------------- |
| reports       | number of reports in the underlying data series (not one per day, see [the dataset docs](/docs/casualties-daily-lebanon)) |
| first_report  | YYYY-MM-DD for the earliest report date in the underlying data series |
| last_update   | YYYY-MM-DD for last report date including these values                |
| killed.total  | continuous cumulative total killed since October 8, 2023 (`killed_cum`, see [the dataset docs](/docs/casualties-daily-lebanon#counting-phases)) |
| injured.total | continuous cumulative total injured since October 8, 2023 (`injured_cum`, see [the dataset docs](/docs/casualties-daily-lebanon#counting-phases)) |
