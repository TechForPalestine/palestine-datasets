...
This dataset provides cumulative totals for those killed and injured in Lebanon since the first report on November 14th, 2023 (see [Counting Phases](#counting-phases) for why the continuous totals below are anchored to October 8, 2023 instead).
