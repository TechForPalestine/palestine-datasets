---
description: Daily reports on casualties in Gaza including number of people killed and injured, and number of events leading to multiple deaths. Also includes breakdown by women, children and role (medical personnel, first responders, and journalists). Useful applications include time series, trend analysis, timelines.
---
